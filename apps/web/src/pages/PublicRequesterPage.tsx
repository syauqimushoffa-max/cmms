...
export function PublicRequesterPage() {
  ...
  return <div className={`requester-app-shell ${signedRequester ? "is-account" : "is-guest"}`}>
    <header className="requester-app-topbar">
      <div className="requester-app-brand"><span><img src="/brand/sugi_symbol.png" alt="PBS Grand" /></span><div><small>PBS CMMS</small><strong>{signedRequester ? `${currentUser.department} Requester` : "Guest Request"}</strong></div></div>
